# ![](/images/icons/Point_Config.png) Point Config - [[source code]](https://github.com/MyceliumGH-Dev/Mycelium/blob/dev/src/Mycelium/Components/BuildingConfigComponents.cs)

Configure Point building parameters

Allows the compact point block typology on blocks handled by the [Massing Generator](/components/Massing_Generator/).

<span class="faint">Grasshopper: **Mycelium** → **Building Types** → `PntCfg`</span>

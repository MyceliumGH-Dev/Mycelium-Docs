# ![](/images/icons/U-Shape_Config.png) U-Shape Config - [[source code]](https://github.com/MyceliumGH-Dev/Mycelium/blob/dev/src/Mycelium/Components/BuildingConfigComponents.cs)

Configure U-Shape building parameters

Allows the U-shaped building typology on blocks handled by the [Massing Generator](/components/Massing_Generator/).

<span class="faint">Grasshopper: **Mycelium** → **Building Types** → `UCfg`</span>

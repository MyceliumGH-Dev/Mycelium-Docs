# ![](/images/icons/Courtyard_Config.png) Courtyard Config - [[source code]](https://github.com/MyceliumGH-Dev/Mycelium/blob/dev/src/Mycelium/Components/BuildingConfigComponents.cs)

Configure Courtyard building parameters

Allows the perimeter block with a central courtyard typology on blocks handled by the [Massing Generator](/components/Massing_Generator/).

<span class="faint">Grasshopper: **Mycelium** → **Building Types** → `CrtCfg`</span>
